...
namespace AdvancedDatabaseAndORMConcept.Controllers
{
    ...
    {
        private readonly AdvancedDatabaseAndORMConceptContext _context;

        public AddressesController(AdvancedDatabaseAndORMConceptContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdvancedDatabaseAndORMConceptContext.Addresses'  is null.");
            }
            var address = await _context.Addresses.FindAsync(id);
            if (address != null)
            {
